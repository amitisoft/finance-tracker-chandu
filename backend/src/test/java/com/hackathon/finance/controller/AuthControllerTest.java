...
class AuthControllerTest {
    ...
    @Test
    void registerAndLoginShouldReturnJwtPayload() throws Exception {
        RegisterRequest registerRequest = new RegisterRequest("alex@example.com", "Password1", "Alex");
        ...
        LoginRequest loginRequest = new LoginRequest("alex@example.com", "Password1");
